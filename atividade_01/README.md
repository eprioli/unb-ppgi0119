...
## Atividade 01 (Aplicação do Algoritmo BPE)

https://github.com/thiagodepaulo/nlp/blob/main/aula_1/exercicio1.md
...
### Instruções
1. Assista ao vídeo tutorial Let's build the GPT Tokenizer. O vídeo explica como o algoritmo de BPE funciona, abordando tanto a parte teórica quanto a prática em Python. Certifique-se de entender o conceito e o funcionamento do algoritmo antes de iniciar a codificação.
...
### Conjunto de Dados
- O arquivo contendo uma coleção de textos pode ser baixado no link [Aqui!](https://unbbr-my.sharepoint.com/personal/thiagodepaulo_unb_br/_layouts/15/onedrive.aspx?id=%2Fpersonal%2Fthiagodepaulo%5Funb%5Fbr%2FDocuments%2Fcorpus%2Ezip&parent=%2Fpersonal%2Fthiagodepaulo%5Funb%5Fbr%2FDocuments&ga=1).
...
4. Coloque a URL do seu github em frente ao seu nome nesta planilha [Aqui!](https://docs.google.com/spreadsheets/d/1F485czBA5zR60J4efsEz8-4YydywazOPCKVjb1o0jUs/edit?gid=0#gid=0).
...
### Dica: 
Certifique-se de que seu código está bem organizado e comentado, explicando a lógica de cada parte da implementação.

### Prazo: 
Submeta a atividade até 29/10/2024 na plataforma da disciplina.